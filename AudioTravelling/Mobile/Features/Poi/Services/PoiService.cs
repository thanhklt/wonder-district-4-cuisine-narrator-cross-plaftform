...
public static class PoiService
{
    ...
    {
        new PoiModel { Id=1, Name="Takoyaki Kukuru", Category="Đồ ăn vặt", DistanceMeters=48, Rating=4.9, IsOpen=true, ImageSource="takoyaki_img.png", Description="Một trong những quán Takoyaki lâu đời nhất Dotonbori. Những viên bạch tuộc nướng tròn trịa, nóng hổi, phủ đầy sốt đặc trưng và rắc katsuobushi thơm lừng – trải nghiệm không thể bỏ qua khi đến Osaka!", AudioScript="Chào mừng đến với Takoyaki Kukuru, điểm dừng đầu tiên trong hành trình ẩm thực Dotonbori của bạn...", Menu=TakoyakiMenu },
        new PoiModel { Id=2, Name="Ichiran Ramen Dotonbori", Category="Ramen", DistanceMeters=120, Rating=4.7, IsOpen=true, ImageSource="ramen_img.png", Description="Chuỗi ramen nổi tiếng thế giới với phong cách ăn một mình độc đáo. Mỗi thực khách ngồi trong ô riêng, tập trung hoàn toàn vào tô ramen tonkotsu đậm đà.", AudioScript="Bạn đang đứng trước Ichiran Ramen, nơi ẩm thực trở thành một hành trình cá nhân đặc biệt...", Menu=RamenMenu },
        new PoiModel { Id=3, Name="Kushikatsu Daruma", Category="Kushikatsu", DistanceMeters=200, Rating=4.8, IsOpen=false, ImageSource="kushikatsu_img.png", Description="Thương hiệu Kushikatsu biểu tượng của Osaka từ 1929. Quy tắc vàng: không được chấm đôi! Hải sản và rau củ tươi, bao bột panko vàng ruộm, chiên ngập dầu.", AudioScript="Kushikatsu Daruma, thành lập năm 1929, là linh hồn ẩm thực của Osaka...", Menu=KushikatsuMenu },
        new PoiModel { Id=4, Name="Kiji Okonomiyaki", Category="Okonomiyaki", DistanceMeters=340, Rating=4.6, IsOpen=false, ImageSource="okonomiyaki_img.png", Description="Nghệ nhân làm Okonomiyaki theo phong cách Osaka cổ truyền từ những năm 1970. Bánh được nướng trực tiếp trên bàn sắt nóng trước mắt thực khách.", AudioScript="Kiji Okonomiyaki, nơi lưu giữ truyền thống ẩm thực Osaka hơn 50 năm...", Menu=OkonomiyakiMenu },
        new PoiModel { Id=5, Name="Cremia Ice Cream", Category="Dessert", DistanceMeters=480, Rating=4.5, IsOpen=true, ImageSource="icecream_img.png", Description="Kem tươi xоắn mềm mịn được làm từ sữa Hokkaido cao cấp. Ốc quế giòn tan tuyệt vời, trở thành biểu tượng check-in của khu phố Dotonbori.", AudioScript="Cremia Ice Cream, nơi từng cây kem là một tác phẩm nghệ thuật vị giác...", Menu=IceCreamMenu },
        new PoiModel { Id=6, Name="Sushi Saito Premium", Category="Sushi", DistanceMeters=620, Rating=4.95, IsOpen=true, ImageSource="sushi_img.png", Description="Nhà hàng sushi omakase cao cấp với đầu bếp Saito Kenji, nguyên là đầu bếp trưởng tại Ginza Tokyo. Nguyên liệu tươi nhập mỗi sáng từ chợ Kuromon.", AudioScript="Sushi Saito Premium - nơi nghệ thuật làm sushi đạt đến đỉnh cao...", Menu= SushiMenu },
        new PoiModel { Id=7, Name="Gyoza no Ohsho", Category="Gyoza", DistanceMeters=850, Rating=4.4, IsOpen=true, ImageSource="gyoza_img.png", Description="Chuỗi gyoza bình dân nhất Nhật Bản với công thức không đổi từ 1967. Vỏ bánh giòn phồng vàng ươm, nhân thịt heo và hẹ thơm lừng, giá cực kỳ phải chăng.", AudioScript="Gyoza no Ohsho, thương hiệu bánh há cảo quốc dân của Nhật Bản...", Menu=GydozaMenu },
    };
